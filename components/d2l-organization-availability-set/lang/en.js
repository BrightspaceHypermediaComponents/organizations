...
export default {
	...
	"currentOrgUnitItemDescription": "Current Org Unit: {name}", // Description of the current orgunit availability item
	"explicitItemDescription": "The {type}: {name}", // Description of an explicit orgunit availability item
