...
export default {
	...
	"deleteSucceeded": "{name} başarıyla kaldırıldı.", // The toast message displayed when a Learning Path is successfully deleted
	"hiddenFromUsers": "Kullanıcılardan gizli", // Visibility status displayed when a learning path is not visible
	...
	"removeLearningPath": "{name}, öğrenme yolundan kaldırın.", // Label for delete learning path button
	...
	"visibleToUsers": "Kullanıcılara görünür", // Visibility status displayed when a learning path is visible
