...
export default {
	"actions": "Eylemler", // Label for learning path context menu
	"actionsForLP": "{name} için eylemler", // Label for within the context menu
	...
	"removeLearningPath": "Sil", // Label for delete learning path button
