...
export default {
	...
	"deleteSucceeded": "Suppression réussie", // The toast message displayed when a Learning Path is successfully deleted
	...
	"searchPlaceholder": "Rechercher…", // Placeholder text for the search input to search the list of org units
